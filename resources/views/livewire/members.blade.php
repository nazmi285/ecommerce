<div>
    ...
    <nav class="navbar fixed-bottom navbar-light" style="bottom:55px;">
        <div class="container">
            ...
            <div class="col-md-12">
                <button type="button" class="btn btn-circle btn-lg btn-primary shadow-sm float-end" id="btnAddMember" data-bs-toggle="modal" data-bs-target="#addMemberModal"><i class="fa fa-plus" aria-hidden="true"></i></button>
            </div>
        </div>
    </nav>
